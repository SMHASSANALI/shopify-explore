  ...
  return (
    <main className="max-w-[900px] mx-auto px-4 py-12">
      ...
      <ul className="list-disc pl-6 space-y-3">
        <li>
          <Link className="text-blue-600 hover:underline" href="/policies/privacy">
            {privacyPolicy?.title || "Privacy Policy"}
          </Link>
        </li>
        <li>
          <Link className="text-blue-600 hover:underline" href="/policies/refund">
            {refundPolicy?.title || "Refund Policy"}
          </Link>
        </li>
        <li>
          <Link className="text-blue-600 hover:underline" href="/policies/terms">
