  ...
  return (
    <div
      className={`rounded-lg overflow-hidden h-full ${
        compressed
          ? "max-w-[200px] sm:max-w-[220px] md:w-[220px] md:h-[360px]"
          : "max-w-[250px] sm:max-w-[270px] md:w-[280px] md:h-[420px]"
      } mx-auto`}
    >
      <Link
        href={`/product/${product.node.handle}`}
      ...
      >
        ...
        {displayImage && (
          <div
            className={`relative aspect-[1/1] flex items-center justify-center w-full border border-gray-300 shadow-sm rounded-md overflow-hidden ${
              compressed
                ? "max-w-[190px] sm:max-w-[210px] md:w-[230px]"
                : "max-w-[240px] sm:max-w-[260px] md:w-[310px]"
            } mx-auto`}
        ...
        <div className="p-1 mt-2 flex flex-col justify-start flex-1 gap-2">
          {compressed ? (
            <h2 className="product-title md:!text-[14px] leading-[110%] !tracking-tighter !text-xs">
              {product.node.title}
            </h2>
          ) : (
